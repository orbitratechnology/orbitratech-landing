...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_products_status" AS ENUM('In development', 'Planned', 'Beta', 'Live');
  ...
  CREATE TABLE "products" (
  	...
  	"status" "enum_products_status" DEFAULT 'In development' NOT NULL,
  	"logo_id" integer NOT NULL,
  	"sort_order" numeric DEFAULT 0,
  	"published" boolean DEFAULT true,
  	"legal_links_privacy_policy_url" varchar,
  	"legal_links_terms_url" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
