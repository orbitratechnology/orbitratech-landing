        ...
        <div className='grid grid-cols-1 md:grid-cols-[300px_1fr] gap-14'>
            ...
            <ul className='list-none'>
              {[
                ...
                <li key={item.id} className='mb-4'>
                  <a
                    href={`#${item.id}`}
                    className='text-slate-600 text-[0.9rem] font-semibold block hover:text-sky-600'>
                    {item.text}
                  </a>
                </li>
              ))}
          ...
          <main id='content' tabIndex={-1} className='outline-none'>
            ...
            <section id='contact' className='mb-16 scroll-mt-10'>
              ...
              <div className='bg-white border border-slate-200 border-l-4 border-l-sky-500 rounded-[20px] p-6 my-6 shadow-sm'>
                <p className='mb-5 text-slate-600 text-[1.05rem] leading-relaxed'>
