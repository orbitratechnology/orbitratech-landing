  ...
  return (
    <div className='min-h-screen bg-slate-50 text-slate-900 overflow-x-hidden'>
      <div className='max-w-[1100px] mx-auto px-6 py-20 relative'>
        <Link
          href='/'
          className='mb-12 inline-block text-sm font-medium text-slate-600 underline-offset-4 hover:text-sky-600 hover:underline'>
          ← Back to home
        </Link>
        ...
        <div className='grid grid-cols-1 md:grid-cols-[280px_1fr] gap-14'>
            ...
            <ul className='list-none'>
              {[
                ...
                <li key={item.id} className='mb-4'>
                  <a
                    href={`#${item.id}`}
                    className='text-slate-600 text-[0.95rem] font-semibold block hover:text-sky-600'>
                    {item.text}
                  </a>
                </li>
              ))}
          ...
          <main id='content' tabIndex={-1} className='outline-none'>
            ...
            <section id='contact' className='mb-16 scroll-mt-10'>
              ...
              <div className='bg-white border-2 border-slate-200 border-l-4 border-l-sky-500 rounded-3xl p-10 mt-8 shadow-sm'>
                <p className='mb-5 text-slate-600 text-[1.05rem] leading-relaxed'>
