...
export function MagicCard(props: MagicCardProps) {
  ...
  return (
    <motion.div
      className={cn(
        'group relative isolate overflow-hidden rounded-3xl border border-white/10 dark:border-white/10 bg-white/5 dark:bg-black/20',
        className,
      )}
      ...
      <div className='absolute inset-px z-20 rounded-[inherit] bg-black/40 dark:bg-black/60 backdrop-blur-xl' />
